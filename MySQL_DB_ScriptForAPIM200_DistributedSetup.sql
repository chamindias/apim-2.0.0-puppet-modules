...
DROP DATABASE IF EXISTS WSO2USER_DB;
CREATE DATABASE WSO2USER_DB;
USE WSO2USER_DB;
...
DROP DATABASE IF EXISTS WSO2REG_DB;
...
drop database if exists WSO2_CONFIG_DB;
create database WSO2_CONFIG_DB;
use WSO2_CONFIG_DB;
...
GRANT ALL ON APIM_DB.* TO root@'%' IDENTIFIED BY "root";
-- GRANT ALL ON WSO2_GOV_DB.* TO root@'%' IDENTIFIED BY "root";
GRANT ALL ON WSO2REG_DB.* TO root@'%' IDENTIFIED BY "root";
GRANT ALL ON WSO2_CONFIG_DB.* TO root@'%' IDENTIFIED BY "root";
GRANT ALL ON WSO2USER_DB.* TO root@'%' IDENTIFIED BY "root";
